...
from utils.utils import roc_plot, print_set
...
parser.add_argument('--attack_rapid', action='store_true', help="launch attacks using self pruning")
...
def main(args):
    ...
    for idx in range(args.model_num):
        ...
        for num in range(args.query_num):
